...
export default function AdminSidebar() {
  ...
  const links: Array<{ href: string; label: string; badge?: string; icon: string }> = [
    ...
    { href: '/admin/payroll-settings', label: 'Payroll Settings', icon: '⚙️' },
    { href: '/admin/staff-earnings', label: 'Staff Earnings', icon: '📊' },
    { href: '/admin/performance-tiers', label: 'Performance Tiers', icon: '🏆' },
    { href: '/admin/team-bonuses', label: 'Team Bonuses', icon: '🎁' },
    { href: '/admin/staff-bonuses', label: 'Individual Bonuses', icon: '💵' },
